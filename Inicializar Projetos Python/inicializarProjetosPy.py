...
str = """# Abrir terminal do editor e escrever o seguinte comando:
# './venv/Scripts/Activate.bat' - ele ira ativar o ambiente virtual do seu projeto.
...
if os.path.isdir(nomePasta):  # vemos de este diretorio ja existe.
    ...
    print('criando pasta...')
    os.mkdir(nomePasta)
    barra_pregresso(30, 'Criando...', 0.1)
    ...
    barra_pregresso(40, 'Criando...', 0.2)
    ...
    os.system(f'{venv}')
    barra_pregresso(50, 'Baixando...', 0.25)
